<section class="content-header" >
	...
	<ol class="breadcrumb">
		<li><i class="fa fa-flask"></i><span>Science: <a href="#" id="science">{{user.getScience()}}</a></span></li>      
        <li><i class="fa fa-btc"></i> <span>Wealth: <a href="#" id="wealth">{{user.getWealth()}}</a></span></li>
        <li><i class="fa fa-flash"></i> <span>Energy: <a href="#" id="energy">{{user.getEnergy()}}</a></span></li>
        <li><i class="fa fa-cog"></i> <span>Metals: <a href="#" id="metals">{{user.getMetals()}}</a></span></li>
        <li><i class="fa fa-leaf"></i> <span>Organic: <a href="#" id="organic">{{user.getLife()}}</a></span></li>
	</ol>
</section>
